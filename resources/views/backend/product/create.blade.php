                ...
                <div class="widget-content nopadding">
                    <form action="{{ route('admin.product.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="product_sku" class="span11" placeholder="Product SKU" />
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="price" class="span11" placeholder="Product Price" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Featured Image :</label>
                            <div class="controls">
                                <input type="file" name="image" class="span11" placeholder="Product Price" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Product Description :</label>
                            <div class="controls">
                                <textarea name="desc" class="textarea_editor span11" rows="6" placeholder="Enter Product Description"></textarea>
                            </div>
                        </div>
